      ...
      <div>
        ...
        >
              ...
              >
                {image ? (
                  <div className="flex flex-col items-center justify-center h-full">
                    ...
                    <button
                      onClick={() => setImage(null)} // Function to remove the image
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                >
                  ...
                  {["Technology", "Health & Fitness", "Lifestyle", "Business & Finance", "Travel", "Food & Recipes", "Entertainment", "Education", "Fashion & Beauty", "Sports", "Politics", "Automobile", "Finance", "Wellness","Environment"].map(
                    (category, index) => (
          ...
          <Button type="submit" className="px-12 py-4" disabled={isLoading}>
            {isEdit ? (isLoading ? "Editing Blog..." : "Edit Blog") : (isLoading ? "Creating Blog..." : "Create Blog")}
          </Button>
          </div>
